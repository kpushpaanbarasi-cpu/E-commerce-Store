...
import { getproductId,loadProductsFetch } from '../../data/products.js';
   ...
   <div class="order-tracking">
    ...
    ${product.name}
        ...
        <div class="progress-labels-container">
          <div class="progress-label ${percentProgress<30?'current-status':''}">
            Preparing
          </div>
          <div class="progress-label ${percentProgress>=30&&percentProgress<100?'current-status':''}">
            Shipped
          </div>
